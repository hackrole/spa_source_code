...
spa.fake = (function(){
  ...
  peopleList = [
    ...
    {name: 'Mike', _id: 'id_02', css_map: {top: 60, left: 20, 'background-color': 'rgb(128, 128, 128)'}},
    {name: 'Pebbles', _id: 'id_03', css_map: {top: 100, left: 20, 'background-color': 'rgb(128, 192, 192)'}},
    {name: 'Wilma', _id: 'id_04', css_map: {top: 140, left: 20, 'background-color': 'rgb(192, 128, 1288)'}},
  ];

  mockSio = (function(){
    var send_listchange, listchage_idto, emit_mock_msg;
    ...
    emit_sio = function(msg_type, data){
      ...
      if(msg_type === 'updateavater' && callback_map.listchange){
