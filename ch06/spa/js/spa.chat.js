...
spa.chat = (function(){
      ...
      + '<div class="spa-chat">'
        ...
        + '<div class="spa-chat-sizer">'
          ...
          + '<div class="spa-chat-msg">'
            ...
            + '<div class="spa-chat-msg-in"></div>'
              + '<form class="spa-chat-msg-form">'
                + '<input type="text">'
                + '<input tye="submit" style="display:none"/>'
  ...
  handleResize = function(){
    ...
    if(stateMap.position_type === 'opened'){
      jqueryMap.$slider.css({height: stateMap.slier_opened_px});
    }
    return true;
  };
  ...
  writeChat = function(person_name, test, is_user){
  ...
  onSetChatee = function(event, arg_map){
    ...
    jqueryMap.$list-box.find('.spa-chat-list-name').removeClass('spa-x-select')
        .end().find('[data-id=' + arg_map.new_chatee.id +']')
  ...
  onUpdatechat = function(event, msg_map){
    var is_user, sender_id, msg_text, chatee, sender;
